...
Submits all program registrations in a csv file, adding team members and program curators as specified. Only adds program registrations that do not already exist.

## `verified_analyses.py`

Checks the verification status of all ingested sequencing files. This lets you know whether the link to the location of each sequencing file is still valid or needs to be updated.